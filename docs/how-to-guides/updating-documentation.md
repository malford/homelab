...
The website is generated using [Material for MkDocs](https://squidfunk.github.io/mkdocs-material) and can be viewed at [homelab.malford.io](https://homelab.malford.io).
...
<!-- - Find the TXT record for `homelab.malford.io` and switch the `ownerID` between `homelab` and `horus` -->
